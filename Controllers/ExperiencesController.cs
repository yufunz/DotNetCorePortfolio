...
namespace DotNetCorePortfolio.Controllers
{
    public class ExperiencesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Location,Duration,Description,CreatedAt")] Experience experience)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Location,Duration,Description,CreatedAt")] Experience experience)
        {
            if (id != experience.Id)
            {
                return NotFound();
